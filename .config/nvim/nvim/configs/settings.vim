...
" Smart wayto move between windows
map <C-j> <C-W>j
map <C-k> <C-W>k
map <C-h> <C-W>h
map <C-l> <C-W>l
...
elseif has("gui_gtk2")
    set gfn=Fira\ Code\ 14,:Hack\ 14,Source\ Code\ Pro\ 12,Bitstream\ Vera\ Sans\ Mono\ 11
elseif has("linux")
    set gfn=Fira\ Code\ 14,:Hack\ 14,Source\ Code\ Pro\ 12,Bitstream\ Vera\ Sans\ Mono\ 11
elseif has("unix")
...
"
" When you sarch with Ack, display your results in cope by doing:
"   <leader>cc
"
...
map <C-b> :call CompileRun()<CR>
imap <C-b> <Esc>:call CompileRun()<CR>
vmap <C-b> <Esc>:call CompileRun()<CR>
map <C-s> :w <CR>
imap <C-s> <Esc>:w<CR>a

autocmd BufNewFile *.cpp execute "0r ~/.config/nvim/templates/".input("Template name: ").".cpp"
"map <F9> :!g++ -g % -o %:r && ./%:r && time ./%:r <CR>
"map <F12> :!gdb ./%:r <CR>
